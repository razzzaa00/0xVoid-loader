-- 0xVOID FADED DELTA | Final God-Tier Remake | razzzaa00
-- 100% Fixed, No Errors, Exact Faded.yarts Replica - 22/11/2025
...
game.StarterGui:SetCore("SendNotification", {
    ...
    Text = "Remake God-Tier Injected - Empire Live 🔥",
    Duration = 6
})

print("0xVOID FADED DELTA → Perfect Remake Injected | razzzaa00")